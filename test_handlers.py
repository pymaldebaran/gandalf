# -*- coding: utf-8 -*-
"""Test file for the gandalf project Telegram protocol handlers."""
...
from handlers import is_command, PlannerChatHandler

# Gandalf element needed for building the tests
import gandalf
